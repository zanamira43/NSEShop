<script setup>
const mens = ref([
  { title: "Men's T.shirt", img: "product1.jpg" },
  { title: "Slim khaki Trousers", img: "product2.jpg" },
...
<template>
  ...
  <div class="my-20">
    ...
    >
      <div class="shadow-lg rounded-lg" v-for="men in mens" :key="men">
        <a href="#">
          <img
            :src="`/products/men/${men.img}`"
            alt=""
